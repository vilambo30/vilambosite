...
const Navbar = () => {
  ...
  return (
    <>
        ...
        <div className="w-full flex justify-between h-14 items-center">
          ...
          <div className="flex items-center gap-x-2.5 -mx-2 text-gray-700 dark:text-gray-300 children:p-2 children:border children:border-x-gray-200 dark:children:border-gray-800 children:bg-gray-100 dark:children:bg-gray-900 children:rounded-md">
            <a
              ...
              rel="noreferer"
              href="#facebook"
              className="transition ease-linear hover:text-orange-700"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width={16}
      ...
      <header className="sticky left-0 top-0 w-full flex items-center h-20 border-b border-b-gray-100 dark:border-b-gray-800 z-40 bg-white dark:bg-gray-800 bg-opacity-80 backdrop-filter backdrop-blur-xl">
        <nav className="relative mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 flex gap-x-5 justify-between items-center">
          ...
          <div
            className={`
          absolute top-full  left-0 bg-white dark:bg-gray-800 lg:bg-transparent border-b border-gray-200 dark:border-gray-800 py-8 lg:py-0 px-5 sm:px-10 md:px-12 lg:px-0 lg:border-none w-full lg:top-0 lg:relative  lg:flex lg:justify-between duration-300 ease-linear
          ${
            navIsOpened
          ...
          >
            <ul className="flex flex-col lg:flex-row gap-6 lg:items-center text-gray-700 dark:text-gray-300 lg:w-full lg:justify-center">
              <li>
                <Link
                  href="/"
                  className="relative py-2.5 duration-300 ease-linear hover:text-orange-600 after:absolute after:w-full after:left-0 after:bottom-0 after:h-px after:rounded-md after:origin-left after:ease-linear after:duration-300 after:scale-x-0 hover:after:scale-100 after:bg-orange-600"
                >
                  Home
                </Link>
              </li>
